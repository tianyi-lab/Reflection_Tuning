...
- The code for reflection and code for selection. 
- The model checkpoints that were trained using our data.
- The high-quality data generated by our method.
...
(The more detailed description will be found in [Data and Model Weights V2](https://github.com/tianyi-lab/Reflection_Tuning?tab=readme-ov-file#data-and-model-weights-v2) )
